...
public class Bank {
    ...
    public void transfer(String fromAccountNumber, String toAccountNumber, double amount) throws InvalidTransactionException {
        ...
        fromAccount.transactionHistory.add(new Transaction(TransactionType.TRANSFER, amount, "Transfer to " + toAccountNumber, LocalDateTime.now()));

        toAccount.transactionHistory.add(new Transaction(TransactionType.TRANSFER, amount, "Transfer from " + fromAccountNumber, LocalDateTime.now()));
    }
